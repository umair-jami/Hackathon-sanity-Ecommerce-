...
// Source: ./sanity/lib/products/getNewProduct.ts
// Variable: NEW_PRODUCT_QUERY
// Query: *[_type == "product" && "NewArrival" in tags]
export type NEW_PRODUCT_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Source: ./sanity/lib/products/getTopSellin.ts
// Variable: TOP_SELLING_QUERY
// Query: *[_type == "product" && "TopSelling" in tags] | order(name desc)
export type TOP_SELLING_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"product\" && \"TopSelling\" in tags] | order(name desc)": TOP_SELLING_QUERYResult;
